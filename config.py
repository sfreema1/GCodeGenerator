...
SYRINGE_CROSS_SECTIONAL_DIAMETER = SYRINGE_DIAMETER[SYRINGE] # mm
SYRINGE_CROSS_SECTIONAL_AREA = math.pi*(SYRINGE_CROSS_SECTIONAL_DIAMETER/2)**2 # uL/mm

# Waste volume
TOTAL_WASTE_VOLUME = SYRINGE_WASTE_SPACE[SYRINGE] + TIP_VOID_VOLUME[TIP]
